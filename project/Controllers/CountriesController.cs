...
namespace project.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NameOfCountry,CapitalCity,Currency,Language")] Countries countries)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NameOfCountry,CapitalCity,Currency,Language")] Countries countries)
        {
            if (ModelState.IsValid)
            {
